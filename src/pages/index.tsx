      ...
      <main>
        <div className={styles.aboutContainer}>
          ...
          <div className={styles.aboutTextContainer}>
            <center><h1>关于Abshir Express</h1></center>
            <p className={styles.aboutText}>Abshir Express是由连续创业者Dr. Abshir Isse创立的跨境电子商务综合服务平台。Dr. Abshir Isse作为天津大学博士，凭借其深厚的学术背景与全球化视野，致力于推动中小企业的国际化发展。其创新的教育实践亦备受认可——自2024年5月起，他通过多语种中文教学视频在全球范围内获得广泛关注，累计播放量突破4亿次，覆盖170个国家及地区，累计服务学员超2900名，彰显了跨文化交流与数字化教育的深度融合。
            ...
            平台采用智能化运营模式，依托大数据分析与人工智能技术，为中小企业提供精准的商业洞察与市场拓展策略，持续为全球贸易生态注入创新动能。</p>
          </div>
        </div>
        <HomepageFeatures />
      </main>
